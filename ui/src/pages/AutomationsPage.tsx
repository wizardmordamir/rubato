...
export function AutomationsPage({ headerActions }: { headerActions?: ReactNode } = {}) {
  ...
  // Secure shareable-string transport: a seed encrypts an exported string and is
  // required to import it (cwip sealToText/openFromText; AES-256-GCM).
  ...
  return (
    <div>
      ...
      {/* Captured sessions not yet turned into a flow — recorded for inspection or
          imported from another machine. Open one in the builder to edit it. */}
      ...
      {/* Share by secure string: a seed encrypts the exported string + is required to import it. */}
